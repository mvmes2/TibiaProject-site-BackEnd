...
const contract_type = () => {
    return connectionDBSlave('contract_type');
}

const guild_logos = () => {
    return connectionDBSlave('guild_logos');
}

module.exports = { streamers, streamers_live_check_time, cupoms, payments, redeem_cupom_storage, products, tickets, tickets_images,
    tickets_response, tickets_response_images, payer_list, contracts, contracts_payment_types, contract_type, guild_logos };
