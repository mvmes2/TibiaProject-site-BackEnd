...
const GuildLogoCheckMiddleware = require('../middlewares/GuildLogoCheckMiddleware');
...
const { uploadGuildLogo, compressGuildLogosMiddleware } = require('./multerGuildLogoConfig');
...
module.exports = app => {
    ...
    app.route('/v1/createNewChar').post(authMiddleware, app.src.main.controllers.AccountController.createCharacterRequest);
    app.route('/v1/character-validation').post(app.src.main.controllers.AccountController.checkCharacterOwnershipRequest);
    app.route('/v1/character-delete').post(authMiddleware, app.src.main.controllers.AccountController.deleteCharacterRequest);
    app.route('/v1/character-updateHidden').post(authMiddleware, app.src.main.controllers.AccountController.updateHidenCharacterRequest);
    app.route('/v1/character-updateComment').post(authMiddleware, app.src.main.controllers.AccountController.updateCharacterCommentRequest);
    ...
    app.route('/v1/User-guild-description').post(authMiddleware, app.src.main.controllers.GuildsController.setGuildDescriptionRequest);
    app.route('/v1/User-guild-logo').post(authMiddleware, GuildLogoCheckMiddleware, uploadGuildLogo, compressGuildLogosMiddleware, app.src.main.controllers.GuildsController.guildLogoRequest);
    ...
    app.route('/v1/get-house-list').get(app.src.main.controllers.HousesController.getHouseListRequest);
    app.route('/v1/get-house').get(app.src.main.controllers.HousesController.getHouseByIdRequest);
